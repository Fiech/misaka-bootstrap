...
let g:local_wiki.path_html        = fnamemodify(expand("%:p:h"), ":h") . '/Html/'   " '/Users/stu/Research/Pathology/Senataxin-LOCAL/NanZhang/Html/'
...
" "
" "
let g:local_wiki.custom_wiki2html = $HOME. '/bin/misaka_md2html.py'
